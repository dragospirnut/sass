...
#monkeys {
  ...
  @include parallax-background("https://s3.amazonaws.com/codecademy-content/projects/sass/landscape.jpg","https://s3.amazonaws.com/codecademy-content/projects/sass/monkeys.jpg");
...
@each $food, $tons-produced in $top-foods{
  ...
  color: fade-out($sea-green, $i*5/100);   
} @else if($i % 3 == 0) {
  
  color: fade-out($pale-gren,$i*5/100);
  
}else { 
  
	color: fade-out($diamond-blue,$i*5/100);
}
     &:before {
